...
class CompaniesCreate extends Component {
 ...
 render() {
 return (<form className="space-y-6" onSubmit={ this.handleSubmit }>
 ...
 <button type="submit"
 className="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase bg-gray-800 rounded-md">
 Create
 </button>
 </form>
 )
